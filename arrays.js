...
// Lastly, an ES6 features: the spread operator. The spread operator, is indicated by these 3 dots "..." expands the contents of the array and takes it out of the array structure.
let shoppingList = ['celery', 'limes', 'lemon', 'grenadine', 'oranges'];
console.log(...shoppingList);